      ...
      <div className="container">
        <div className="row">
          ...
          <div className="column col-md-3 mb-4 ">
            <h3 >Atal Utkrisht Government Inter College, Shrikot, Chinyalisaur, Uttarkashi</h3>
          ...
          <div className="column col-md-3 mb-4">
            <h4>Contact Us</h4>
            <p>Atal Utkrisht Government Inter College, Shrikot, Chinyalisaur, Uttarkashi</p>
            <p>Pin code -</p>
            <p>Email: </p>
            <p>Phone:</p>
          </div>
        ...
        <div className="footer-bottom-text">
          <p className='text-center'>&copy; 2025 Atal Utkrisht Government Inter College, Shrikot, Chinyalisaur, Uttarkashi All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
